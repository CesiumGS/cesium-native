...
## 💄 Source Code Formatting (change to [NL.17](http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#nl17-use-kr-derived-layout))
...
## 📛 Naming (change to [NL.10](http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines#Rl-camel))

Our naming differs from the naming proposed in the C++ Core Guidlines, because we don't like typing underscores as much as Bjarne does. Our conventions are:
