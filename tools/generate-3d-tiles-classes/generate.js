...
function generate(options, schema) {
  const { schemaCache, config, outputDir, writerOutputDir } = options;
  ...
  const header = `
        // This file was generated by generate-3d-tiles-classes.
  ...
  const readerHeaderOutputDir = path.join(writerOutputDir, "generated");
