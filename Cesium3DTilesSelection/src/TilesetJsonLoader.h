...
struct TilesetJsonLoaderOptions {
  bool loadFeatureContent = false;
};
...
public:
  ...
  const TilesetJsonLoaderOptions getLoaderOptions() const noexcept;
...
private:
  ...
  TilesetJsonLoaderOptions _options;
