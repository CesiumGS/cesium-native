...
namespace CesiumGltf {
     ...
     */
    struct CESIUMGLTF_API ExtensionExtStructuralMetadata final : public CesiumUtility::ExtensibleObject {
        /**
        ...
        /**
         * @brief The class that property values conform to. The value shall be a class ID declared in the `classes` dictionary of the metadata schema.
         */
...
accum += int64_t(this->properties.bucket_count() * (sizeof(std::string) + sizeof(CesiumUtility::JsonValue)));
