...
namespace CesiumGltf {
    ...
    struct CESIUMGLTF_API AccessorSpec : public CesiumGltf::NamedObject {
        ...
        /**
         * @brief Known values for Specifies if the accessor's elements are scalars, vectors, or matrices.
         */
        struct Type {
        ...
        /**
         * @brief Specifies if the accessor's elements are scalars, vectors, or matrices.
         * 
        ...
        /**
         * @brief Sparse storage of elements that deviate from their initialization value.
         */
...
if(this->sparse) {
accum += this->sparse->getSizeBytes() - int64_t(sizeof(CesiumGltf::AccessorSparse));
      }
          return accum;
        }
