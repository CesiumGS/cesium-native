...
namespace CesiumGltf {
    ...
    struct CESIUMGLTF_API ExtensionExtInstanceFeatures final : public CesiumUtility::ExtensibleObject {
        ...
        int64_t getSizeBytes() const {
          ...
          accum += int64_t(sizeof(CesiumGltf::ExtensionExtInstanceFeaturesFeatureId) * this->featureIds.capacity());
      for(const CesiumGltf::ExtensionExtInstanceFeaturesFeatureId& value : this->featureIds) {
accum += value.getSizeBytes() - int64_t(sizeof(CesiumGltf::ExtensionExtInstanceFeaturesFeatureId));
      }
          return accum;
        }
