...
namespace CesiumGltf {
    ...
    struct CESIUMGLTF_API Class final : public CesiumUtility::ExtensibleObject {
        ...
        /**
         * @brief A dictionary, where each key is a property ID and each value is an object defining the property. Property IDs must be alphanumeric identifiers matching the regular expression `^[a-zA-Z_][a-zA-Z0-9_]*$`.
         */
...
accum += int64_t(this->properties.bucket_count() * (sizeof(std::string) + sizeof(CesiumGltf::ClassProperty)));
