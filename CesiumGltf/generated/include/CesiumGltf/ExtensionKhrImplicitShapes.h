...
struct CESIUMGLTF_API ExtensionKhrImplicitShapes final
   ...
   */
  std::vector<CesiumGltf::ExtensionKhrImplicitShapesShape> shapes;
  ...
  int64_t getSizeBytes() const {
    ...
    accum += int64_t(
        sizeof(CesiumGltf::ExtensionKhrImplicitShapesShape) *
        this->shapes.capacity());
    for (const CesiumGltf::ExtensionKhrImplicitShapesShape& value :
         this->shapes) {
      accum += value.getSizeBytes() -
               int64_t(sizeof(CesiumGltf::ExtensionKhrImplicitShapesShape));
    }
    return accum;
  }
};
