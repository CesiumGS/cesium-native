...
namespace CesiumGltf {
     ...
     */
    struct CESIUMGLTF_API FeatureTableProperty final : public CesiumUtility::ExtensibleObject {
        static inline constexpr const char* TypeName = "FeatureTableProperty";

        /**
         * @brief Known values for The type of values in `arrayOffsetBufferView` and `stringOffsetBufferView`.
         */
        struct OffsetType {
