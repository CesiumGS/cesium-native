 ...
 */
struct CESIUMGLTF_API ExtensionExtFeatureMetadataEnum final
    : public CesiumUtility::ExtensibleObject {
  static inline constexpr const char* TypeName =
      "ExtensionExtFeatureMetadataEnum";
   ...
   * are not allowed.
   */
  std::vector<CesiumGltf::ExtensionExtFeatureMetadataEnumValue> values;
};
} // namespace CesiumGltf
