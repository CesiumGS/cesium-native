...
namespace CesiumGltf {
    ...
    struct CESIUMGLTF_API Material final : public CesiumGltf::NamedObject {
         ...
         */
        struct AlphaMode {
            /** @brief The alpha value is ignored, and the rendered output is fully opaque. */
            inline static const std::string OPAQUE = "OPAQUE";

            /** @brief The rendered output is either fully opaque or fully transparent depending on the alpha value and the specified `alphaCutoff` value; the exact appearance of the edges **MAY** be subject to implementation-specific techniques such as "`Alpha-to-Coverage`". */
            inline static const std::string MASK = "MASK";

            /** @brief The alpha value is used to composite the source and destination areas. The rendered output is combined with the background using the normal painting operation (i.e. the Porter and Duff over operator). */
