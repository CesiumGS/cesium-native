...
/**
 * @brief Structural metadata about EXT_voxels attributes.
 */
struct CESIUMGLTF_API ExtensionExtVoxelsExtStructuralMetadata final
    : public CesiumUtility::ExtensibleObject {
  /**
   * @brief The original name of this type.
   */
  static constexpr const char* TypeName =
      "ExtensionExtVoxelsExtStructuralMetadata";
  ...
  int64_t getSizeBytes() const {
    int64_t accum = 0;
    accum += int64_t(sizeof(ExtensionExtVoxelsExtStructuralMetadata));
