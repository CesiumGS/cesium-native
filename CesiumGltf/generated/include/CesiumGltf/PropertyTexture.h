...
namespace CesiumGltf {
    /**
     * @brief Properties conforming to a class, organized as property values stored in textures.
     */
    struct CESIUMGLTF_API PropertyTexture final : public CesiumUtility::ExtensibleObject {
...
accum += int64_t(this->properties.bucket_count() * (sizeof(std::string) + sizeof(CesiumGltf::PropertyTextureProperty)));
      for(const auto& [k, v] : this->properties) {
accum += int64_t(k.capacity() * sizeof(char) - sizeof(std::string));
accum += v.getSizeBytes() - int64_t(sizeof(CesiumGltf::PropertyTextureProperty));
      }
          return accum;
        }
