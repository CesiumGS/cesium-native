...
accum += this->baseColorTexture->getSizeBytes() - int64_t(sizeof(CesiumGltf::TextureInfo));
      }
if(this->metallicRoughnessTexture) {
accum += this->metallicRoughnessTexture->getSizeBytes() - int64_t(sizeof(CesiumGltf::TextureInfo));
      }
          return accum;
        }
