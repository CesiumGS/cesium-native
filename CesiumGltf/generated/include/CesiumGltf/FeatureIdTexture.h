...
namespace CesiumGltf {
    ...
    struct CESIUMGLTF_API FeatureIdTexture final : public TextureInfo {
        ...
        /**
         * @brief Texture channels containing feature IDs, identified by index. Feature IDs may be packed into multiple channels if a single channel does not have sufficient bit depth to represent all feature ID values. The values are packed in little-endian order.
         */
