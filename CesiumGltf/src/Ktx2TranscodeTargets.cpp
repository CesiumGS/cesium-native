...
Ktx2TranscodeTargets::Ktx2TranscodeTargets(
  ...
  if (supportedFormats.ETC2_EAC_RG11) {
    ...
    this->ETC1S_RG = GpuCompressedPixelFormat::ETC1_RGB;
  ...
  if (supportedFormats.ASTC_4x4_RGBA) {
    ...
    // } else if (HighQuality) { // decode to pixels
  } else if (supportedFormats.ETC2_RGBA) {
    this->UASTC_RGBA = GpuCompressedPixelFormat::ETC2_RGBA;
    // } else if (supportedFormats.ETC1_RGB) {
    // It is recommended to transcode into two separate etc1_rgb images here,
    // but we'll just skip the hassle now and consider bc1/bc3 instead.
  } else if (supportedFormats.BC3_RGBA) {
  ...
  if (supportedFormats.ASTC_4x4_RGBA) {
    ...
    // } else if (HighQuality) { // decode to pixels}
  } else if (supportedFormats.ETC2_EAC_RG11) {
  ...
  if (supportedFormats.ASTC_4x4_RGBA) {
    ...
    // } else if (HighQuality) { // decode to pixels}
  } else if (supportedFormats.ETC2_EAC_R11) {
  ...
  // target, then it will be fully decompressed into RGBA pixels.
}