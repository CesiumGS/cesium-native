...
namespace CesiumGltf {
    /**
     * @brief Feature IDs to be used as indices to property arrays in the feature table.
     */
    struct CESIUMGLTF_API FeatureIDs final : public CesiumUtility::ExtensibleObject {
