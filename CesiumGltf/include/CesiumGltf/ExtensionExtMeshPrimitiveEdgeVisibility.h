...
struct CESIUMGLTF_API ExtensionExtMeshPrimitiveEdgeVisibility final
  ...
  struct VisibilityType {
    ...
    static constexpr int32_t HIDDEN = 0;
     ...
     * triangle) */
    static constexpr int32_t SILHOUETTE = 1;

    /** @brief Hard edge - the edge should always be drawn. */
    static constexpr int32_t HARD_EDGE = 2;
    ...
    static constexpr int32_t REPEATED_HARD_EDGE = 3;
  };
