...
class IPropertyTableViewVisitor {
public:
  virtual ~IPropertyTableViewVisitor() noexcept = default;
  virtual void
  visit(const PropertyTablePropertyView<int8_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint8_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int16_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint16_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int32_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint32_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int64_t, false>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint64_t, false>& view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<float>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<double>& view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<bool>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<std::string_view>& view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::vec<2, uint64_t>, false>&
            view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<glm::vec<2, float>>& view) noexcept = 0;
  virtual void visit(
      const PropertyTablePropertyView<glm::vec<2, double>>& view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::vec<3, uint64_t>, false>&
            view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<glm::vec<3, float>>& view) noexcept = 0;
  virtual void visit(
      const PropertyTablePropertyView<glm::vec<3, double>>& view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::vec<4, uint64_t>, false>&
            view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<glm::vec<4, float>>& view) noexcept = 0;
  virtual void visit(
      const PropertyTablePropertyView<glm::vec<4, double>>& view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::mat<2, 2, uint64_t>, false>&
            view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<2, 2, float>>&
                         view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<2, 2, double>>&
                         view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::mat<3, 3, uint64_t>, false>&
            view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<3, 3, float>>&
                         view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<3, 3, double>>&
                         view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<glm::mat<4, 4, uint64_t>, false>&
            view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<4, 4, float>>&
                         view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<glm::mat<4, 4, double>>&
                         view) noexcept = 0;
  virtual void
  ...
  virtual void visit(const PropertyTablePropertyView<PropertyArrayView<double>>&
                         view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<PropertyArrayView<bool>>&
                         view) noexcept = 0;
  virtual void
  ...
  visit(const PropertyTablePropertyView<
        PropertyArrayView<glm::mat<2, 2, double>>>& view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<
  ...
  virtual void
  visit(const PropertyTablePropertyView<
        PropertyArrayView<glm::mat<3, 3, double>>>& view) noexcept = 0;
  virtual void visit(const PropertyTablePropertyView<
  ...
  virtual void
  visit(const PropertyTablePropertyView<
        PropertyArrayView<glm::mat<4, 4, double>>>& view) noexcept = 0;

  virtual void
  visit(const PropertyTablePropertyView<int8_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint8_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int16_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint16_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int32_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint32_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<int64_t, true>& view) noexcept = 0;
  virtual void
  visit(const PropertyTablePropertyView<uint64_t, true>& view) noexcept = 0;
