...
public:
  ...
  /**
   * @brief Gets the number from the value, or a default if the value does not
   * contain a number.
   *
   * @param defaultValue The default value to return if the value is not a
   * number.
   * @return The number.
   */
  ...
  /**
   * @brief Gets the bool from the value, or a default if the value does not
   * contain a bool.
   *
  ...
  /**
   * @brief Gets the string from the value, or a default if the value does not
   * contain a string.
   *
   * @param defaultValue The default value to return if the value is not a
   * string.
  ...
  /**
   * @brief Gets a typed value corresponding to the given key in the object
   * represented by this instance.
   *
   * If this instance is not a {@link JsonValue::Object}, returns `nullptr`. If
   * the key does not exist in this object, returns `nullptr`. If the named
   * value does not have the type T, returns nullptr.
   *
   * @tparam T The expected type of the value.
   * @param key The key for which to retrieve the value from this object.
   * @return A pointer to the requested value, or nullptr if the value cannot be
   * obtained as requested.
   */
  template <typename T> const T* getValueForKey(const std::string& key) const {
   ...
   * obtained as requested.
   */
  template <typename T> T* getValueForKey(const std::string& key) {
  ...
  /**
   * @brief Gets the value corresponding to the given key in the object
   * represented by this instance.
   *
   * If this instance is not a {@link JsonValue::Object}, returns `nullptr`. If
   * the key does not exist in this object, returns `nullptr`. If the named
