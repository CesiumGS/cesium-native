...
TEST_CASE("Cesium3DTiles::TilesetReader") {
  ...
  std::filesystem::path gltfFile = Cesium3DTilesReader_TEST_DATA_DIR;
  gltfFile /= "tileset.json";
  ...
  CHECK(
      ...
      0.899060112939701);
  CHECK(tileset.properties->additionalProperties.at("Height").minimum == 1.0);
  CHECK(tileset.properties->additionalProperties.at("Height").maximum == 241.6);
