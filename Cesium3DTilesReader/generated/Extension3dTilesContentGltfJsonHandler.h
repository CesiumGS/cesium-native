...
class Extension3dTilesContentGltfJsonHandler
...
public:
  ...
  void
  reset(IJsonHandler* pParentHandler, Extension3dTilesContentGltf* pObject);
...
protected:
  IJsonHandler* readObjectKeyExtension3dTilesContentGltf(
      const std::string& objectType,
      const std::string_view& str,
      Extension3dTilesContentGltf& o);

private:
  Extension3dTilesContentGltf* _pObject = nullptr;
  CesiumJsonReader::
