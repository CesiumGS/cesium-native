...
class ExtensionTileset3dTilesMetadataLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionTileset3dTilesMetadataLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionTileset3dTilesMetadataLegacy& o);

private:
  Cesium3DTiles::ExtensionTileset3dTilesMetadataLegacy* _pObject = nullptr;
  Extension3dTilesMetadataSchemaLegacyJsonHandler _schema;
  CesiumJsonReader::StringJsonHandler _schemaUri;
  Extension3dTilesMetadataStatisticsLegacyJsonHandler _statistics;
  CesiumJsonReader::DictionaryJsonHandler<
      Cesium3DTiles::Extension3dTilesMetadataGroupMetadataLegacy,
      Extension3dTilesMetadataGroupMetadataLegacyJsonHandler>
      _groups;
  Extension3dTilesMetadataTilesetMetadataLegacyJsonHandler _tileset;
};
} // namespace Cesium3DTilesReader
