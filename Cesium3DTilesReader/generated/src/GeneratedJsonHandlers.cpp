...
void Extension3dTilesImplicitTilingExtension3dTilesMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
Extension3dTilesImplicitTilingExtension3dTilesMetadataJsonHandler::
  ...
  assert(this->_pObject);
  return this
      ->readObjectKeyExtension3dTilesImplicitTilingExtension3dTilesMetadata(
          Cesium3DTiles::
              Extension3dTilesImplicitTilingExtension3dTilesMetadata::TypeName,
          str,
          *this->_pObject);
}
  ...
  std::any& value =
      o.extensions
          .emplace(
              extensionName,
              Cesium3DTiles::
                  Extension3dTilesImplicitTilingExtension3dTilesMetadata())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<
          Cesium3DTiles::
              Extension3dTilesImplicitTilingExtension3dTilesMetadata&>(value));
}
