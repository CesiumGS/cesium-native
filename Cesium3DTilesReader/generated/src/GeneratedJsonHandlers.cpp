...
void Extension3dTilesMultipleContentsLegacyJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::Extension3dTilesMultipleContentsLegacy* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
Extension3dTilesMultipleContentsLegacyJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtension3dTilesMultipleContentsLegacy(
      Cesium3DTiles::Extension3dTilesMultipleContentsLegacy::TypeName,
      str,
      *this->_pObject);
}
...
void Extension3dTilesMultipleContentsLegacyJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(
              extensionName,
              Cesium3DTiles::Extension3dTilesMultipleContentsLegacy())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<Cesium3DTiles::Extension3dTilesMultipleContentsLegacy&>(
          value));
}

CesiumJsonReader::IJsonHandler*
Extension3dTilesMultipleContentsLegacyJsonHandler::
    readObjectKeyExtension3dTilesMultipleContentsLegacy(
        const std::string& objectType,
        const std::string_view& str,
        Cesium3DTiles::Extension3dTilesMultipleContentsLegacy& o) {
  using namespace std::string_literals;
...
void ExtensionSubtree3dTilesMultipleContentsLegacyJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::ExtensionSubtree3dTilesMultipleContentsLegacy* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionSubtree3dTilesMultipleContentsLegacyJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionSubtree3dTilesMultipleContentsLegacy(
      Cesium3DTiles::ExtensionSubtree3dTilesMultipleContentsLegacy::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler*
ExtensionSubtree3dTilesMultipleContentsLegacyJsonHandler::
    readObjectKeyExtensionSubtree3dTilesMultipleContentsLegacy(
        const std::string& objectType,
        const std::string_view& str,
        Cesium3DTiles::ExtensionSubtree3dTilesMultipleContentsLegacy& o) {
  using namespace std::string_literals;
...
SubtreeBufferViewJsonHandler::SubtreeBufferViewJsonHandler(
    const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context),
      _buffer(),
      _byteOffset(),
...
void SubtreeBufferViewJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
SubtreeBufferViewJsonHandler::readObjectKey(const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeySubtreeBufferView(
      Cesium3DTiles::SubtreeBufferView::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
SubtreeBufferViewJsonHandler::readObjectKeySubtreeBufferView(
    const std::string& objectType,
    const std::string_view& str,
...
SubtreeBufferJsonHandler::SubtreeBufferJsonHandler(
    const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context),
      _uri(),
      _byteLength(),
...
void SubtreeBufferJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::SubtreeBuffer* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
SubtreeBufferJsonHandler::readObjectKey(const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeySubtreeBuffer(
      Cesium3DTiles::SubtreeBuffer::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
SubtreeBufferJsonHandler::readObjectKeySubtreeBuffer(
    const std::string& objectType,
    const std::string_view& str,
