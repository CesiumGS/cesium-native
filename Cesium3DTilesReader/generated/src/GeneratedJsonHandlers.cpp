...
#include <Cesium3DTilesReader/ExtensionMaxarContentGeoJsonReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
ExtensionMaxarContentGeoJsonJsonHandler::
    ExtensionMaxarContentGeoJsonJsonHandler(
        const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options) {}

void ExtensionMaxarContentGeoJsonJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionMaxarContentGeoJsonJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyExtensionMaxarContentGeoJson(
      Cesium3DTiles::ExtensionMaxarContentGeoJson::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionMaxarContentGeoJsonJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, Cesium3DTiles::ExtensionMaxarContentGeoJson())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<Cesium3DTiles::ExtensionMaxarContentGeoJson&>(value));
}

CesiumJsonReader::IJsonHandler* ExtensionMaxarContentGeoJsonJsonHandler::
    readObjectKeyExtensionMaxarContentGeoJson(
        const std::string& objectType,
        const std::string_view& str,
...
ExtensionMaxarContentGeoJsonReader::ExtensionMaxarContentGeoJsonReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions&
ExtensionMaxarContentGeoJsonReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
ExtensionMaxarContentGeoJsonReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::ExtensionMaxarContentGeoJson>
ExtensionMaxarContentGeoJsonReader::readFromJson(
    const std::span<const std::byte>& data) const {
  ExtensionMaxarContentGeoJsonJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
CesiumJsonReader::ReadJsonResult<
    std::vector<Cesium3DTiles::ExtensionMaxarContentGeoJson>>
ExtensionMaxarContentGeoJsonReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      Cesium3DTiles::ExtensionMaxarContentGeoJson,
      ExtensionMaxarContentGeoJsonJsonHandler>
      handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
