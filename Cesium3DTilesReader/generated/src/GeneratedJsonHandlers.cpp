...
// DO NOT EDIT THIS FILE!
// NOLINTBEGIN(readability-duplicate-include)
#include "Extension3dTilesDynamicJsonHandler.h"
#include "registerReaderExtensions.h"

#include <Cesium3DTiles/Extension3dTilesDynamic.h>
#include <Cesium3DTilesReader/Extension3dTilesDynamicReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
Extension3dTilesDynamicJsonHandler::Extension3dTilesDynamicJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _dimensions(options) {}

void Extension3dTilesDynamicJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
Extension3dTilesDynamicJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyExtension3dTilesDynamic(
      Cesium3DTiles::Extension3dTilesDynamic::TypeName,
      str,
      *this->_pObject);
}
...
void Extension3dTilesDynamicJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, Cesium3DTiles::Extension3dTilesDynamic())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<Cesium3DTiles::Extension3dTilesDynamic&>(value));
}

CesiumJsonReader::IJsonHandler*
Extension3dTilesDynamicJsonHandler::readObjectKeyExtension3dTilesDynamic(
    const std::string& objectType,
    const std::string_view& str,
...
Extension3dTilesDynamicReader::Extension3dTilesDynamicReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions&
Extension3dTilesDynamicReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
Extension3dTilesDynamicReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::Extension3dTilesDynamic>
Extension3dTilesDynamicReader::readFromJson(
    const std::span<const std::byte>& data) const {
  Extension3dTilesDynamicJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
Extension3dTilesDynamicReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      Cesium3DTiles::Extension3dTilesDynamic,
      Extension3dTilesDynamicJsonHandler>
      handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <Cesium3DTilesReader/Extension3dTilesDynamicDimensionsValueReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
void Extension3dTilesDynamicDimensionsValueJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
Extension3dTilesDynamicDimensionsValueJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyExtension3dTilesDynamicDimensionsValue(
      Cesium3DTiles::Extension3dTilesDynamicDimensionsValue::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler*
Extension3dTilesDynamicDimensionsValueJsonHandler::
    readObjectKeyExtension3dTilesDynamicDimensionsValue(
        const std::string& objectType,
        const std::string_view& str,
...
CesiumJsonReader::JsonReaderOptions&
Extension3dTilesDynamicDimensionsValueReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
Extension3dTilesDynamicDimensionsValueReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    Cesium3DTiles::Extension3dTilesDynamicDimensionsValue>
Extension3dTilesDynamicDimensionsValueReader::readFromJson(
    const std::span<const std::byte>& data) const {
  Extension3dTilesDynamicDimensionsValueJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
Extension3dTilesDynamicDimensionsValueReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      Cesium3DTiles::Extension3dTilesDynamicDimensionsValue,
      Extension3dTilesDynamicDimensionsValueJsonHandler>
...
// DO NOT EDIT THIS FILE!
// NOLINTBEGIN(readability-duplicate-include)
#include "DynamicContentJsonHandler.h"
#include "registerReaderExtensions.h"

#include <Cesium3DTiles/DynamicContent.h>
#include <Cesium3DTilesReader/DynamicContentReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
DynamicContentJsonHandler::DynamicContentJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _dynamicContents(options) {}

void DynamicContentJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::DynamicContent* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
DynamicContentJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyDynamicContent(
      Cesium3DTiles::DynamicContent::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
DynamicContentJsonHandler::readObjectKeyDynamicContent(
    const std::string& objectType,
    const std::string_view& str,
    Cesium3DTiles::DynamicContent& o) {
  using namespace std::string_literals;

  if ("dynamicContents"s == str) {
    return property(
        "dynamicContents",
...
DynamicContentReader::DynamicContentReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& DynamicContentReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
DynamicContentReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::DynamicContent>
DynamicContentReader::readFromJson(
    const std::span<const std::byte>& data) const {
  DynamicContentJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::DynamicContent>
DynamicContentReader::readFromJson(const rapidjson::Value& value) const {
  DynamicContentJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<Cesium3DTiles::DynamicContent>>
DynamicContentReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<Cesium3DTiles::DynamicContent, DynamicContentJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <Cesium3DTilesReader/DynamicContentDynamicContentsValueReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
CesiumJsonReader::IJsonHandler*
DynamicContentDynamicContentsValueJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyDynamicContentDynamicContentsValue(
      Cesium3DTiles::DynamicContentDynamicContentsValue::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler* DynamicContentDynamicContentsValueJsonHandler::
    readObjectKeyDynamicContentDynamicContentsValue(
        const std::string& objectType,
        const std::string_view& str,
...
DynamicContentDynamicContentsValueReader::
    DynamicContentDynamicContentsValueReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions&
DynamicContentDynamicContentsValueReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
DynamicContentDynamicContentsValueReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    Cesium3DTiles::DynamicContentDynamicContentsValue>
DynamicContentDynamicContentsValueReader::readFromJson(
    const std::span<const std::byte>& data) const {
  DynamicContentDynamicContentsValueJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
DynamicContentDynamicContentsValueReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      Cesium3DTiles::DynamicContentDynamicContentsValue,
      DynamicContentDynamicContentsValueJsonHandler>
