...
PaddingReader::PaddingReader() { registerExtensions(this->_options); }
...
VoxelContentJsonHandler::VoxelContentJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _buffers(options),
...
void VoxelContentJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::VoxelContent* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}
...
CesiumJsonReader::IJsonHandler*
VoxelContentJsonHandler::readObjectKeyVoxelContent(
    const std::string& objectType,
    const std::string_view& str,
  ...
  if ("voxelTable"s == str)
    return property("voxelTable", this->_voxelTable, o.voxelTable);

  return this->readObjectKeyExtensibleObject(objectType, str, *this->_pObject);
}

VoxelContentReader::VoxelContentReader() { registerExtensions(this->_options); }

CesiumJsonReader::JsonReaderOptions& VoxelContentReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
VoxelContentReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelContent>
VoxelContentReader::readFromJson(const gsl::span<const std::byte>& data) const {
  VoxelContentJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelContent>
VoxelContentReader::readFromJson(const rapidjson::Value& value) const {
  VoxelContentJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<Cesium3DTiles::VoxelContent>>
VoxelContentReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<Cesium3DTiles::VoxelContent, VoxelContentJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
VoxelBufferViewJsonHandler::VoxelBufferViewJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _buffer(),
      _byteOffset(),
...
void VoxelBufferViewJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::VoxelBufferView* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}
...
CesiumJsonReader::IJsonHandler*
VoxelBufferViewJsonHandler::readObjectKeyVoxelBufferView(
    const std::string& objectType,
    const std::string_view& str,
...
VoxelBufferViewReader::VoxelBufferViewReader() {
  registerExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& VoxelBufferViewReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
VoxelBufferViewReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelBufferView>
VoxelBufferViewReader::readFromJson(
    const gsl::span<const std::byte>& data) const {
  VoxelBufferViewJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelBufferView>
VoxelBufferViewReader::readFromJson(const rapidjson::Value& value) const {
  VoxelBufferViewJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<Cesium3DTiles::VoxelBufferView>>
VoxelBufferViewReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
...
VoxelBufferJsonHandler::VoxelBufferJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _uri(),
      _byteLength(),
...
void VoxelBufferJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    Cesium3DTiles::VoxelBuffer* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}
...
CesiumJsonReader::IJsonHandler*
VoxelBufferJsonHandler::readObjectKeyVoxelBuffer(
    const std::string& objectType,
    const std::string_view& str,
...
VoxelBufferReader::VoxelBufferReader() { registerExtensions(this->_options); }

CesiumJsonReader::JsonReaderOptions& VoxelBufferReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
VoxelBufferReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelBuffer>
VoxelBufferReader::readFromJson(const gsl::span<const std::byte>& data) const {
  VoxelBufferJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<Cesium3DTiles::VoxelBuffer>
VoxelBufferReader::readFromJson(const rapidjson::Value& value) const {
  VoxelBufferJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<Cesium3DTiles::VoxelBuffer>>
VoxelBufferReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
...
SubtreeReader::SubtreeReader() { registerExtensions(this->_options); }
...
AvailabilityReader::AvailabilityReader() { registerExtensions(this->_options); }
...
TilesetReader::TilesetReader() { registerExtensions(this->_options); }
...
TileReader::TileReader() { registerExtensions(this->_options); }
...
SubtreesReader::SubtreesReader() { registerExtensions(this->_options); }
...
ContentReader::ContentReader() { registerExtensions(this->_options); }
...
PropertiesReader::PropertiesReader() { registerExtensions(this->_options); }
