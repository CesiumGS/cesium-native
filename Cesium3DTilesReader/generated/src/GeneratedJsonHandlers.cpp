...
#include <vector>
  ...
  void StatisticsJsonHandler::reset(
    ...
    CesiumJsonReader::ExtensibleObjectJsonHandler::reset(
        pParentHandler,
        pObject);
    this->_pObject = pObject;
  }

  CesiumJsonReader::IJsonHandler* StatisticsJsonHandler::readObjectKey(
      const std::string_view& str) {
    CESIUM_ASSERT(this->_pObject);
  ...
  CesiumJsonReader::IJsonHandler*
  StatisticsJsonHandler::readObjectKeyStatistics(
      const std::string& objectType,
      const std::string_view& str,
    ...
    return this->readObjectKeyExtensibleObject(
        objectType,
        str,
        *this->_pObject);
  }
  ...
  const CesiumJsonReader::JsonReaderOptions& StatisticsReader::getOptions()
      const {
    return this->_options;
  }
