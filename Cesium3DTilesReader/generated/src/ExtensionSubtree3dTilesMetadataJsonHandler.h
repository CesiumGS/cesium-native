...
class ExtensionSubtree3dTilesMetadataJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionSubtree3dTilesMetadata(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionSubtree3dTilesMetadata& o);

private:
  Cesium3DTiles::ExtensionSubtree3dTilesMetadata* _pObject = nullptr;
