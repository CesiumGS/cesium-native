...
#include <Cesium3DTiles/ExtensionContent3dTilesVoxelContent.h>
...
class ExtensionContent3dTilesVoxelContentJsonHandler
    : public CesiumJsonReader::ExtensibleObjectJsonHandler,
      public CesiumJsonReader::IExtensionJsonHandler {
public:
  using ValueType = Cesium3DTiles::ExtensionContent3dTilesVoxelContent;

  static inline constexpr const char* ExtensionName = "3DTILES_content_voxels";

  ExtensionContent3dTilesVoxelContentJsonHandler(
      const CesiumJsonReader::ExtensionReaderContext& context) noexcept;
  void reset(
      IJsonHandler* pParentHandler,
      Cesium3DTiles::ExtensionContent3dTilesVoxelContent* pObject);
...
protected:
  IJsonHandler* readObjectKeyExtensionContent3dTilesVoxelContent(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionContent3dTilesVoxelContent& o);

private:
  Cesium3DTiles::ExtensionContent3dTilesVoxelContent* _pObject = nullptr;
  CesiumJsonReader::
