...
class ExtensionSubtree3dTilesMultipleContentsLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionSubtree3dTilesMultipleContentsLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionSubtree3dTilesMultipleContentsLegacy& o);

private:
  Cesium3DTiles::ExtensionSubtree3dTilesMultipleContentsLegacy* _pObject =
      nullptr;
