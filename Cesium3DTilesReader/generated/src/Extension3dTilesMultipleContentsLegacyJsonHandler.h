...
class Extension3dTilesMultipleContentsLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtension3dTilesMultipleContentsLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::Extension3dTilesMultipleContentsLegacy& o);

private:
  Cesium3DTiles::Extension3dTilesMultipleContentsLegacy* _pObject = nullptr;
