...
class ExtensionContent3dTilesMetadataLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionContent3dTilesMetadataLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionContent3dTilesMetadataLegacy& o);

private:
  Cesium3DTiles::ExtensionContent3dTilesMetadataLegacy* _pObject = nullptr;
