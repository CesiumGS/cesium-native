...
class ExtensionSubtree3dTilesMetadataLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionSubtree3dTilesMetadataLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionSubtree3dTilesMetadataLegacy& o);

private:
  Cesium3DTiles::ExtensionSubtree3dTilesMetadataLegacy* _pObject = nullptr;
