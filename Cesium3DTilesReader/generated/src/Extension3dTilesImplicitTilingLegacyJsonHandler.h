...
class Extension3dTilesImplicitTilingLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtension3dTilesImplicitTilingLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::Extension3dTilesImplicitTilingLegacy& o);

private:
  Cesium3DTiles::Extension3dTilesImplicitTilingLegacy* _pObject = nullptr;
  ...
  Extension3dTilesImplicitTilingSubtreesLegacyJsonHandler _subtrees;
};
} // namespace Cesium3DTilesReader
