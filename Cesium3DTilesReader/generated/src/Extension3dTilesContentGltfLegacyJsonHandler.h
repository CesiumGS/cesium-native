...
class Extension3dTilesContentGltfLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtension3dTilesContentGltfLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::Extension3dTilesContentGltfLegacy& o);

private:
  Cesium3DTiles::Extension3dTilesContentGltfLegacy* _pObject = nullptr;
  CesiumJsonReader::
