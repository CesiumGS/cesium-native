...
class ExtensionTile3dTilesMetadataLegacyJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionTile3dTilesMetadataLegacy(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionTile3dTilesMetadataLegacy& o);

private:
  Cesium3DTiles::ExtensionTile3dTilesMetadataLegacy* _pObject = nullptr;
