...
class ExtensionSubtree3dTilesMultipleContentsJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionSubtree3dTilesMultipleContents(
      const std::string& objectType,
      const std::string_view& str,
      Cesium3DTiles::ExtensionSubtree3dTilesMultipleContents& o);

private:
  Cesium3DTiles::ExtensionSubtree3dTilesMultipleContents* _pObject = nullptr;
  CesiumJsonReader::
