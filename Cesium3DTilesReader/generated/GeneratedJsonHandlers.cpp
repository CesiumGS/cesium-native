...
Extension3dTilesBoundingVolumeS2JsonHandler::readObjectKey(
  ...
  return this->readObjectKeyExtension3dTilesBoundingVolumeS2(
      Extension3dTilesBoundingVolumeS2::TypeName,
      str,
      *this->_pObject);
}
...
void Extension3dTilesBoundingVolumeS2JsonHandler::reset(
    ...
    const std::string_view& extensionName) {
  std::any& value =
      o.extensions.emplace(extensionName, Extension3dTilesBoundingVolumeS2())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<Extension3dTilesBoundingVolumeS2&>(value));
}
