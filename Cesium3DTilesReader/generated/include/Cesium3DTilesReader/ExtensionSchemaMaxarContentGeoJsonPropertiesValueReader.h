 ...
 * "ExtensionSchemaMaxarContentGeoJsonPropertiesValue" instances from JSON.
 */
...
public:
   ...
   * ExtensionSchemaMaxarContentGeoJsonPropertiesValue from a byte buffer.
   *
  ...
  /**
   * @brief Reads an instance of
   * ExtensionSchemaMaxarContentGeoJsonPropertiesValue from a rapidJson::Value.
   *
