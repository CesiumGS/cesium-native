 ...
 * "Extension3dTilesContentConditionalDimensionsValue" instances from JSON.
 */
...
public:
   ...
   * Extension3dTilesContentConditionalDimensionsValue from a byte buffer.
   *
  ...
  /**
   * @brief Reads an instance of
   * Extension3dTilesContentConditionalDimensionsValue from a rapidJson::Value.
   *
