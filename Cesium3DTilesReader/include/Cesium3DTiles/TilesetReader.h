...
public:
  ...
  AssetJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);
...
public:
  ...
  BoundingVolumeJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);
...
class CODEGEN_API TileContentJsonHandler
    : public CesiumJsonReader::ExtensibleObjectJsonHandler {
public:
  using ValueType = TileContent;

  TileContentJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);

  void reset(IJsonHandler* pParentHandler, TileContent* pObject);

  virtual IJsonHandler* readObjectKey(const std::string_view& str) override;

protected:
  IJsonHandler* readObjectKeyTileContent(
      const std::string& objectType,
      const std::string_view& str,
      TileContent& o);

private:
  TileContent* _pObject = nullptr;
...
public:
  ...
  TileJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);
...
private:
  ...
  CesiumJsonReader::
      ArrayJsonHandler<double, CesiumJsonReader::DoubleJsonHandler>
          _transform;
  TileContentJsonHandler _content;
...
public:
  ...
  public:
    ...
    PropertiesJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);
  ...
  TilesetJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context);
