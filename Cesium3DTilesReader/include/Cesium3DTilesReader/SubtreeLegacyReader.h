 ...
 * {@link SubtreeLegacyReader::readSubtree}.
 */
struct CESIUM3DTILESREADER_API SubtreeLegacyReaderResult {
  /**
 ...
 */
class CESIUM3DTILESREADER_API SubtreeLegacyReader {
public:
  /**
   ...
   */
  SubtreeLegacyReaderResult readSubtree(const gsl::span<const std::byte>& data) const;
