...
#include <CesiumLegacyTerrain/LayerReader.h>
...
void LayerJsonHandler::reset(
    ...
    CesiumLegacyTerrain::Layer* pObject) {
...
LayerJsonHandler::readObjectKey(const std::string_view& str) {
  ...
  return this->readObjectKeyLayer(
      CesiumLegacyTerrain::Layer::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::ReadJsonResult<CesiumLegacyTerrain::Layer>
...
CesiumJsonReader::ReadJsonResult<std::vector<CesiumLegacyTerrain::Layer>>
LayerReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumLegacyTerrain::Layer, LayerJsonHandler>
...
#include <CesiumLegacyTerrain/AvailabilityRectangleReader.h>
...
AvailabilityRectangleJsonHandler::readObjectKey(const std::string_view& str) {
  ...
  return this->readObjectKeyAvailabilityRectangle(
      CesiumLegacyTerrain::AvailabilityRectangle::TypeName,
      str,
      *this->_pObject);
}
