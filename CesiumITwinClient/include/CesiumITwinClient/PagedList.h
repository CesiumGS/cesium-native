...
public:
  ...
  /**
   * @brief Checks whether this PagedList contains a URL to another page that can be fetched.
   */
  bool hasNextUrl() const { return this->_nextUrl.has_value(); }

  /**
   * @brief Checks whether this PagedList contains a URL to a previous page that can be fetched.
   */
