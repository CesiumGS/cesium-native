...
class CesiumUtilityConan(ConanFile):
    ...
    description = "Reads JSON from a buffer into statically-typed classes."
    topics = () # TODO
    ...
    def package_info(self):
      ...
      self.cpp_info.set_property("cmake_file_name", "CesiumJsonReader")
      self.cpp_info.set_property("cmake_target_name", "CesiumJsonReader::CesiumJsonReader")