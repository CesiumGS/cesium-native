...
namespace CesiumGltf {
  ...
  public:
    using ValueType = ExtensionKhrDracoMeshCompression;
    ...
    void reset(IJsonHandler* pParentHandler, ExtensionKhrDracoMeshCompression* pObject);
  ...
  protected:
    IJsonHandler* readObjectKeyExtensionKhrDracoMeshCompression(const std::string& objectType, const std::string_view& str, ExtensionKhrDracoMeshCompression& o);

  private:

    ExtensionKhrDracoMeshCompression* _pObject = nullptr;
