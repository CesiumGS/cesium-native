...
namespace CesiumGltf {
  ...
  public:
    using ValueType = ExtensionModelExtFeatureMetadata;
    ...
    void reset(IJsonHandler* pParentHandler, ExtensionModelExtFeatureMetadata* pObject);
  ...
  protected:
    IJsonHandler* readObjectKeyExtensionModelExtFeatureMetadata(const std::string& objectType, const std::string_view& str, ExtensionModelExtFeatureMetadata& o);

  private:

    ExtensionModelExtFeatureMetadata* _pObject = nullptr;
    SchemaJsonHandler _schema;
    CesiumJsonReader::StringJsonHandler _schemaUri;
    StatisticsJsonHandler _statistics;
    CesiumJsonReader::DictionaryJsonHandler<FeatureTable, FeatureTableJsonHandler> _featureTables;
    CesiumJsonReader::DictionaryJsonHandler<FeatureTexture, FeatureTextureJsonHandler> _featureTextures;
  };
}
