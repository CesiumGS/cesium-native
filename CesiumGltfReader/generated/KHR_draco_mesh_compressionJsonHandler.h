...
namespace CesiumGltf {
  ...
  class KHR_draco_mesh_compressionJsonHandler : public ExtensibleObjectJsonHandler {
  public:
  ...
  protected:
    IJsonHandler* KHR_draco_mesh_compressionKey(const char* str, KHR_draco_mesh_compression& o);

  private:

    KHR_draco_mesh_compression* _pObject;
