...
namespace CesiumGltf {
  ...
  public:
    using ValueType = ExtensionMeshPrimitiveExtFeatureMetadata;
    ...
    void reset(IJsonHandler* pParentHandler, ExtensionMeshPrimitiveExtFeatureMetadata* pObject);
  ...
  protected:
    IJsonHandler* readObjectKeyExtensionMeshPrimitiveExtFeatureMetadata(const std::string& objectType, const std::string_view& str, ExtensionMeshPrimitiveExtFeatureMetadata& o);

  private:

    ExtensionMeshPrimitiveExtFeatureMetadata* _pObject = nullptr;
    CesiumJsonReader::ArrayJsonHandler<FeatureIDAttribute, FeatureIDAttributeJsonHandler> _featureIdAttributes;
    CesiumJsonReader::ArrayJsonHandler<FeatureIDTexture, FeatureIDTextureJsonHandler> _featureIdTextures;
