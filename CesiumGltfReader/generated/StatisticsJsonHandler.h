...
namespace CesiumGltf {
  ...
  protected:
    IJsonHandler* readObjectKeyStatistics(const std::string& objectType, const std::string_view& str, Statistics& o);

  private:

    Statistics* _pObject = nullptr;
    CesiumJsonReader::DictionaryJsonHandler<ClassStatistics, ClassStatisticsJsonHandler> _classes;
  };
}
