...
CameraOrthographicJsonHandler::CameraOrthographicJsonHandler(const ReaderContext& context) noexcept : ExtensibleObjectJsonHandler(context), _xmag(), _ymag(), _zfar(), _znear() {}
