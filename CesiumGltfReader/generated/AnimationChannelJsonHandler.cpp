...
AnimationChannelJsonHandler::AnimationChannelJsonHandler(const ReaderContext& context) noexcept : ExtensibleObjectJsonHandler(context), _sampler(), _target(context) {}
