...
#include <CesiumJsonReader/VariantJsonHandler.h>
...
class ExtensionMeshPrimitiveExtMeshFeaturesJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionMeshPrimitiveExtMeshFeatures(
...
private:
  ...
  CesiumJsonReader::ArrayJsonHandler<
      std::variant<
          CesiumGltf::ExtensionExtMeshFeaturesFeatureIdAttribute,
          CesiumGltf::ExtensionExtMeshFeaturesFeatureIdTexture>,
      CesiumJsonReader::VariantJsonHandler<
