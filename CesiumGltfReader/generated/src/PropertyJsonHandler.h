...
public:
  using ValueType = CesiumGltf::Property;

  PropertyJsonHandler(
      const CesiumJsonReader::ExtensionReaderContext& context) noexcept;
  void reset(IJsonHandler* pParentHandler, CesiumGltf::Property* pObject);
...
protected:
  IJsonHandler* readObjectKeyProperty(
      ...
      CesiumGltf::Property& o);

private:
  CesiumGltf::Property* _pObject = nullptr;
