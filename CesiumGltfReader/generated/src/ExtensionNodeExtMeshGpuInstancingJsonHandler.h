...
class ExtensionNodeExtMeshGpuInstancingJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionNodeExtMeshGpuInstancing(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionNodeExtMeshGpuInstancing& o);

private:
  CesiumGltf::ExtensionNodeExtMeshGpuInstancing* _pObject = nullptr;
