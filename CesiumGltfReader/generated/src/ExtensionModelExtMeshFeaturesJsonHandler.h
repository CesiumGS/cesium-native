...
class ExtensionModelExtMeshFeaturesJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionModelExtMeshFeatures(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionModelExtMeshFeatures& o);

private:
  CesiumGltf::ExtensionModelExtMeshFeatures* _pObject = nullptr;
  ExtensionExtMeshFeaturesSchemaJsonHandler _schema;
  CesiumJsonReader::StringJsonHandler _schemaUri;
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionExtMeshFeaturesPropertyTable,
      ExtensionExtMeshFeaturesPropertyTableJsonHandler>
      _propertyTables;
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionExtMeshFeaturesPropertyTexture,
