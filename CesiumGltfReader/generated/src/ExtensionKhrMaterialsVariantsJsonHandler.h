...
class ExtensionKhrMaterialsVariantsJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionKhrMaterialsVariants(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionKhrMaterialsVariants& o);

private:
  CesiumGltf::ExtensionKhrMaterialsVariants* _pObject = nullptr;
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionKhrMaterialsVariantsValue,
