...
class ExtensionMeshPrimitiveCesiumTileEdgesJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionMeshPrimitiveCesiumTileEdges(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionMeshPrimitiveCesiumTileEdges& o);

private:
  CesiumGltf::ExtensionMeshPrimitiveCesiumTileEdges* _pObject = nullptr;
