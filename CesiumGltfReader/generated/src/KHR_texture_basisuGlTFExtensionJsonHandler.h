...
class KHR_texture_basisuGlTFExtensionJsonHandler
    : public CesiumJsonReader::ExtensibleObjectJsonHandler,
      public CesiumJsonReader::IExtensionJsonHandler {
public:
  using ValueType = CesiumGltf::KHR_texture_basisuGlTFExtension;
...
protected:
  IJsonHandler* readObjectKeyKHR_texture_basisuGlTFExtension(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::KHR_texture_basisuGlTFExtension& o);

private:
  CesiumGltf::KHR_texture_basisuGlTFExtension* _pObject = nullptr;
