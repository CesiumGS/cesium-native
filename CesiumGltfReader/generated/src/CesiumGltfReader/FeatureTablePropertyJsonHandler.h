...
namespace CesiumGltfReader {
  ...
  public:
    ...
    void reset(IJsonHandler* pParentHandler, CesiumGltf::FeatureTableProperty* pObject);

    virtual IJsonHandler* readObjectKey(const std::string_view& str) override;

  protected:
    IJsonHandler* readObjectKeyFeatureTableProperty(const std::string& objectType, const std::string_view& str, CesiumGltf::FeatureTableProperty& o);
