...
#include "CesiumGltfReader/FeatureIDAttributeJsonHandler.h"
#include "CesiumGltfReader/FeatureIDTextureJsonHandler.h"
...
namespace CesiumGltfReader {
  class ExtensionMeshPrimitiveExtFeatureMetadataJsonHandler : public CesiumJsonReader::ExtensibleObjectJsonHandler, public CesiumJsonReader::IExtensionJsonHandler {
  public:
    ...
    ExtensionMeshPrimitiveExtFeatureMetadataJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context) noexcept;
    void reset(IJsonHandler* pParentHandler, CesiumGltf::ExtensionMeshPrimitiveExtFeatureMetadata* pObject);
  ...
  protected:
    IJsonHandler* readObjectKeyExtensionMeshPrimitiveExtFeatureMetadata(const std::string& objectType, const std::string_view& str, CesiumGltf::ExtensionMeshPrimitiveExtFeatureMetadata& o);

  private:

    CesiumGltf::ExtensionMeshPrimitiveExtFeatureMetadata* _pObject = nullptr;
    CesiumJsonReader::ArrayJsonHandler<CesiumGltf::FeatureIDAttribute, FeatureIDAttributeJsonHandler> _featureIdAttributes;
    CesiumJsonReader::ArrayJsonHandler<CesiumGltf::FeatureIDTexture, FeatureIDTextureJsonHandler> _featureIdTextures;
    CesiumJsonReader::ArrayJsonHandler<std::string, CesiumJsonReader::StringJsonHandler> _featureTextures;
  };
}
