...
class ExtensionMaterialsUnlitJsonHandler
    : public CesiumJsonReader::ExtensibleObjectJsonHandler,
      public CesiumJsonReader::IExtensionJsonHandler {
public:
  using ValueType = CesiumGltf::ExtensionMaterialsUnlit;
...
protected:
  IJsonHandler* readObjectKeyExtensionMaterialsUnlit(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionMaterialsUnlit& o);

private:
  CesiumGltf::ExtensionMaterialsUnlit* _pObject = nullptr;
};
} // namespace CesiumGltfReader
