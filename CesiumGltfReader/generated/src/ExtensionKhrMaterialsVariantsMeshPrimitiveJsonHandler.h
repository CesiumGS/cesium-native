...
class ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionKhrMaterialsVariantsMeshPrimitive(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive& o);

private:
  CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive* _pObject = nullptr;
