...
class ExtensionMaterialKhrMaterialsUnlitJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionMaterialKhrMaterialsUnlit(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionMaterialKhrMaterialsUnlit& o);

private:
  CesiumGltf::ExtensionMaterialKhrMaterialsUnlit* _pObject = nullptr;
};
} // namespace CesiumGltfReader
