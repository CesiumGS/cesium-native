...
// DO NOT EDIT THIS FILE!
// NOLINTBEGIN(readability-duplicate-include)
#include "BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler.h"
#include "registerReaderExtensions.h"

#include <CesiumGltf/BENTLEY_materials_line_styleGlTFMaterialExtension.h>
#include <CesiumGltfReader/BENTLEY_materials_line_styleGlTFMaterialExtensionReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler::
    BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler(
        const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _width(),
...
void BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyBENTLEY_materials_line_styleGlTFMaterialExtension(
      CesiumGltf::BENTLEY_materials_line_styleGlTFMaterialExtension::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler*
BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler::
    readObjectKeyBENTLEY_materials_line_styleGlTFMaterialExtension(
        const std::string& objectType,
        const std::string_view& str,
...
CesiumJsonReader::JsonReaderOptions&
BENTLEY_materials_line_styleGlTFMaterialExtensionReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
BENTLEY_materials_line_styleGlTFMaterialExtensionReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    CesiumGltf::BENTLEY_materials_line_styleGlTFMaterialExtension>
BENTLEY_materials_line_styleGlTFMaterialExtensionReader::readFromJson(
    const std::span<const std::byte>& data) const {
  BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler handler(
      this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
CesiumJsonReader::ReadJsonResult<
    std::vector<CesiumGltf::BENTLEY_materials_line_styleGlTFMaterialExtension>>
BENTLEY_materials_line_styleGlTFMaterialExtensionReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::BENTLEY_materials_line_styleGlTFMaterialExtension,
      BENTLEY_materials_line_styleGlTFMaterialExtensionJsonHandler>
