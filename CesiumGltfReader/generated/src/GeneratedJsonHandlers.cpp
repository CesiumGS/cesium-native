...
// DO NOT EDIT THIS FILE!
// NOLINTBEGIN(readability-duplicate-include)
#include "LegacyShapeJsonHandler.h"
#include "NamedObjectJsonHandler.h"
#include "registerReaderExtensions.h"

#include <CesiumGltf/LegacyShape.h>
#include <CesiumGltfReader/LegacyShapeReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
#include <CesiumUtility/Assert.h>
...
LegacyShapeJsonHandler::LegacyShapeJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumGltfReader::NamedObjectJsonHandler(options),
      _type(),
      _sphere(options),
...
void LegacyShapeJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::LegacyShape* pObject) {
  CesiumGltfReader::NamedObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
LegacyShapeJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyLegacyShape(
      CesiumGltf::LegacyShape::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
LegacyShapeJsonHandler::readObjectKeyLegacyShape(
    const std::string& objectType,
    const std::string_view& str,
...
LegacyShapeReader::LegacyShapeReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& LegacyShapeReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
LegacyShapeReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyShape>
LegacyShapeReader::readFromJson(const std::span<const std::byte>& data) const {
  LegacyShapeJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyShape>
LegacyShapeReader::readFromJson(const rapidjson::Value& value) const {
  LegacyShapeJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<CesiumGltf::LegacyShape>>
LegacyShapeReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumGltf::LegacyShape, LegacyShapeJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <CesiumGltfReader/LegacyCylinderReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
LegacyCylinderJsonHandler::LegacyCylinderJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _height(),
      _radiusBottom(),
...
void LegacyCylinderJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::LegacyCylinder* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
LegacyCylinderJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyLegacyCylinder(
      CesiumGltf::LegacyCylinder::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
LegacyCylinderJsonHandler::readObjectKeyLegacyCylinder(
    const std::string& objectType,
    const std::string_view& str,
...
LegacyCylinderReader::LegacyCylinderReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& LegacyCylinderReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
LegacyCylinderReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyCylinder>
LegacyCylinderReader::readFromJson(
    const std::span<const std::byte>& data) const {
  LegacyCylinderJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyCylinder>
LegacyCylinderReader::readFromJson(const rapidjson::Value& value) const {
  LegacyCylinderJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<CesiumGltf::LegacyCylinder>>
LegacyCylinderReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumGltf::LegacyCylinder, LegacyCylinderJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <CesiumGltfReader/LegacyCapsuleReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
LegacyCapsuleJsonHandler::LegacyCapsuleJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _height(),
      _radiusBottom(),
...
void LegacyCapsuleJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::LegacyCapsule* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
LegacyCapsuleJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyLegacyCapsule(
      CesiumGltf::LegacyCapsule::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
LegacyCapsuleJsonHandler::readObjectKeyLegacyCapsule(
    const std::string& objectType,
    const std::string_view& str,
...
LegacyCapsuleReader::LegacyCapsuleReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& LegacyCapsuleReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
LegacyCapsuleReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyCapsule>
LegacyCapsuleReader::readFromJson(
    const std::span<const std::byte>& data) const {
  LegacyCapsuleJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyCapsule>
LegacyCapsuleReader::readFromJson(const rapidjson::Value& value) const {
  LegacyCapsuleJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<CesiumGltf::LegacyCapsule>>
LegacyCapsuleReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumGltf::LegacyCapsule, LegacyCapsuleJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <CesiumGltfReader/LegacyBoxReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
LegacyBoxJsonHandler::LegacyBoxJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options), _size() {}

void LegacyBoxJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::LegacyBox* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
LegacyBoxJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyLegacyBox(
      CesiumGltf::LegacyBox::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler* LegacyBoxJsonHandler::readObjectKeyLegacyBox(
    const std::string& objectType,
    const std::string_view& str,
...
LegacyBoxReader::LegacyBoxReader() { registerReaderExtensions(this->_options); }

CesiumJsonReader::JsonReaderOptions& LegacyBoxReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions& LegacyBoxReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyBox>
LegacyBoxReader::readFromJson(const std::span<const std::byte>& data) const {
  LegacyBoxJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacyBox>
LegacyBoxReader::readFromJson(const rapidjson::Value& value) const {
  LegacyBoxJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<CesiumGltf::LegacyBox>>
LegacyBoxReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumGltf::LegacyBox, LegacyBoxJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
...
#include <CesiumGltfReader/LegacySphereReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
LegacySphereJsonHandler::LegacySphereJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options), _radius() {}

void LegacySphereJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::LegacySphere* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
LegacySphereJsonHandler::readObjectKey(const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyLegacySphere(
      CesiumGltf::LegacySphere::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler*
LegacySphereJsonHandler::readObjectKeyLegacySphere(
    const std::string& objectType,
    const std::string_view& str,
...
LegacySphereReader::LegacySphereReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions& LegacySphereReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
LegacySphereReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacySphere>
LegacySphereReader::readFromJson(const std::span<const std::byte>& data) const {
  LegacySphereJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::LegacySphere>
LegacySphereReader::readFromJson(const rapidjson::Value& value) const {
  LegacySphereJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}

CesiumJsonReader::ReadJsonResult<std::vector<CesiumGltf::LegacySphere>>
LegacySphereReader::readArrayFromJson(const rapidjson::Value& value) const {
  CesiumJsonReader::
      ArrayJsonHandler<CesiumGltf::LegacySphere, LegacySphereJsonHandler>
          handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
