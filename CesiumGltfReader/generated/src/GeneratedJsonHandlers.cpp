...
void ExtensionNodeExtInstanceFeaturesJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionNodeExtInstanceFeaturesJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionNodeExtInstanceFeatures(
      CesiumGltf::ExtensionNodeExtInstanceFeatures::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionNodeExtInstanceFeaturesJsonHandler::reset(
  ...
  std::any& value = o.extensions
                        .emplace(
                            extensionName,
                            CesiumGltf::ExtensionNodeExtInstanceFeatures())
                        .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::ExtensionNodeExtInstanceFeatures&>(value));
}

CesiumJsonReader::IJsonHandler* ExtensionNodeExtInstanceFeaturesJsonHandler::
    readObjectKeyExtensionNodeExtInstanceFeatures(
        const std::string& objectType,
        const std::string_view& str,
