...
// DO NOT EDIT THIS FILE!
// NOLINTBEGIN(readability-duplicate-include)
#include "ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler.h"
#include "registerReaderExtensions.h"

#include <CesiumGltf/ExtensionPropertyTableExtStructuralMetadataHierarchy.h>
#include <CesiumGltfReader/ExtensionPropertyTableExtStructuralMetadataHierarchyReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler::
    ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler(
        const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _parentPropertyTables(),
      _parentIndices() {}

void ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::ExtensionPropertyTableExtStructuralMetadataHierarchy* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this
      ->readObjectKeyExtensionPropertyTableExtStructuralMetadataHierarchy(
...
ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler::
    readObjectKeyExtensionPropertyTableExtStructuralMetadataHierarchy(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::ExtensionPropertyTableExtStructuralMetadataHierarchy& o) {
  using namespace std::string_literals;

  if ("parentPropertyTables"s == str) {
    return property(
        "parentPropertyTables",
        this->_parentPropertyTables,
        o.parentPropertyTables);
  }
  if ("parentIndices"s == str) {
    return property("parentIndices", this->_parentIndices, o.parentIndices);
  }
...
CesiumJsonReader::JsonReaderOptions&
ExtensionPropertyTableExtStructuralMetadataHierarchyReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
ExtensionPropertyTableExtStructuralMetadataHierarchyReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    CesiumGltf::ExtensionPropertyTableExtStructuralMetadataHierarchy>
ExtensionPropertyTableExtStructuralMetadataHierarchyReader::readFromJson(
    const std::span<const std::byte>& data) const {
  ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler handler(
      this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
CesiumJsonReader::ReadJsonResult<std::vector<
    CesiumGltf::ExtensionPropertyTableExtStructuralMetadataHierarchy>>
ExtensionPropertyTableExtStructuralMetadataHierarchyReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionPropertyTableExtStructuralMetadataHierarchy,
      ExtensionPropertyTableExtStructuralMetadataHierarchyJsonHandler>
