...
void EXT_structural_metadataGlTFDocumentExtensionJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
EXT_structural_metadataGlTFDocumentExtensionJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyEXT_structural_metadataGlTFDocumentExtension(
      CesiumGltf::EXT_structural_metadataGlTFDocumentExtension::TypeName,
      str,
      *this->_pObject);
}
...
void EXT_structural_metadataGlTFDocumentExtensionJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(
              extensionName,
              CesiumGltf::EXT_structural_metadataGlTFDocumentExtension())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::EXT_structural_metadataGlTFDocumentExtension&>(
          value));
}

CesiumJsonReader::IJsonHandler*
EXT_structural_metadataGlTFDocumentExtensionJsonHandler::
    readObjectKeyEXT_structural_metadataGlTFDocumentExtension(
        const std::string& objectType,
        const std::string_view& str,
...
CesiumJsonReader::JsonReaderOptions&
EXT_structural_metadataGlTFDocumentExtensionReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
EXT_structural_metadataGlTFDocumentExtensionReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    CesiumGltf::EXT_structural_metadataGlTFDocumentExtension>
EXT_structural_metadataGlTFDocumentExtensionReader::readFromJson(
    const std::span<const std::byte>& data) const {
  EXT_structural_metadataGlTFDocumentExtensionJsonHandler handler(
      this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
CesiumJsonReader::ReadJsonResult<
    std::vector<CesiumGltf::EXT_structural_metadataGlTFDocumentExtension>>
EXT_structural_metadataGlTFDocumentExtensionReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::EXT_structural_metadataGlTFDocumentExtension,
      EXT_structural_metadataGlTFDocumentExtensionJsonHandler>
...
ExtensionKhrSpzCompressionJsonHandler::ExtensionKhrSpzCompressionJsonHandler(
    const CesiumJsonReader::JsonReaderOptions& options) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(options),
      _bufferView(),
      _numPoints(),
...
void ExtensionKhrSpzCompressionJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionKhrSpzCompressionJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyExtensionKhrSpzCompression(
      CesiumGltf::ExtensionKhrSpzCompression::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionKhrSpzCompressionJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, CesiumGltf::ExtensionKhrSpzCompression())
          .first->second;
  this->reset(
      pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionKhrSpzCompressionJsonHandler::readObjectKeyExtensionKhrSpzCompression(
    const std::string& objectType,
    const std::string_view& str,
  ...
  if ("numPoints"s == str) {
    return property("numPoints", this->_numPoints, o.numPoints);
  }
  if ("shDegree"s == str) {
    return property("shDegree", this->_shDegree, o.shDegree);
  }
  if ("fractionalBits"s == str) {
    return property("fractionalBits", this->_fractionalBits, o.fractionalBits);
  }
  if ("flags"s == str) {
    return property("flags", this->_flags, o.flags);
  }
  if ("version"s == str) {
...
ExtensionKhrSpzCompressionReader::ExtensionKhrSpzCompressionReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions&
ExtensionKhrSpzCompressionReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
ExtensionKhrSpzCompressionReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionKhrSpzCompression>
ExtensionKhrSpzCompressionReader::readFromJson(
    const std::span<const std::byte>& data) const {
...
CesiumJsonReader::ReadJsonResult<
    std::vector<CesiumGltf::ExtensionKhrSpzCompression>>
ExtensionKhrSpzCompressionReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionKhrSpzCompression,
      ExtensionKhrSpzCompressionJsonHandler>
      handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(value, handler);
}
