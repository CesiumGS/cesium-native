...
#include <CesiumGltfReader/ExtensionMeshPrimitiveEdgeVisibilityReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/ExtensibleObjectJsonHandler.h>
#include <CesiumJsonReader/IJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
void ExtensionMeshPrimitiveEdgeVisibilityJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionMeshPrimitiveEdgeVisibilityJsonHandler::readObjectKey(
    const std::string_view& str) {
  CESIUM_ASSERT(this->_pObject);
  return this->readObjectKeyExtensionMeshPrimitiveEdgeVisibility(
      CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionMeshPrimitiveEdgeVisibilityJsonHandler::reset(
  ...
  std::any& value = o.extensions
                        .emplace(
                            extensionName,
                            CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility())
                        .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility&>(value));
}

CesiumJsonReader::IJsonHandler*
ExtensionMeshPrimitiveEdgeVisibilityJsonHandler::
    readObjectKeyExtensionMeshPrimitiveEdgeVisibility(
        const std::string& objectType,
        const std::string_view& str,
...
ExtensionMeshPrimitiveEdgeVisibilityReader::
    ExtensionMeshPrimitiveEdgeVisibilityReader() {
  registerReaderExtensions(this->_options);
}

CesiumJsonReader::JsonReaderOptions&
ExtensionMeshPrimitiveEdgeVisibilityReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
ExtensionMeshPrimitiveEdgeVisibilityReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<
    CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility>
ExtensionMeshPrimitiveEdgeVisibilityReader::readFromJson(
    const std::span<const std::byte>& data) const {
  ExtensionMeshPrimitiveEdgeVisibilityJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
CesiumJsonReader::ReadJsonResult<
    std::vector<CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility>>
ExtensionMeshPrimitiveEdgeVisibilityReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionMeshPrimitiveEdgeVisibility,
      ExtensionMeshPrimitiveEdgeVisibilityJsonHandler>
