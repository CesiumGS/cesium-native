...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "EXT_texture_webpGlTFExtensionJsonHandler.h"
...
void EXT_texture_webpGlTFExtensionJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
EXT_texture_webpGlTFExtensionJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyEXT_texture_webpGlTFExtension(
      CesiumGltf::EXT_texture_webpGlTFExtension::TypeName,
      str,
      *this->_pObject);
}
...
void EXT_texture_webpGlTFExtensionJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, CesiumGltf::EXT_texture_webpGlTFExtension())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::EXT_texture_webpGlTFExtension&>(value));
}

CesiumJsonReader::IJsonHandler* EXT_texture_webpGlTFExtensionJsonHandler::
    readObjectKeyEXT_texture_webpGlTFExtension(
        const std::string& objectType,
        const std::string_view& str,
