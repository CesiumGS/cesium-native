...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionNodeExtStructuralMetadataJsonHandler.h"
#include "registerReaderExtensions.h"

#include <CesiumGltf/ExtensionNodeExtStructuralMetadata.h>
#include <CesiumGltfReader/ExtensionNodeExtStructuralMetadataReader.h>
#include <CesiumJsonReader/ArrayJsonHandler.h>
#include <CesiumJsonReader/JsonReader.h>
...
void ExtensionNodeExtStructuralMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionNodeExtStructuralMetadataJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionNodeExtStructuralMetadata(
      CesiumGltf::ExtensionNodeExtStructuralMetadata::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionNodeExtStructuralMetadataJsonHandler::reset(
  ...
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::ExtensionNodeExtStructuralMetadata&>(value));
}

CesiumJsonReader::IJsonHandler* ExtensionNodeExtStructuralMetadataJsonHandler::
    readObjectKeyExtensionNodeExtStructuralMetadata(
        const std::string& objectType,
        const std::string_view& str,
...
CesiumJsonReader::JsonReaderOptions&
ExtensionNodeExtStructuralMetadataReader::getOptions() {
  return this->_options;
}

const CesiumJsonReader::JsonReaderOptions&
ExtensionNodeExtStructuralMetadataReader::getOptions() const {
  return this->_options;
}

CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionNodeExtStructuralMetadata>
ExtensionNodeExtStructuralMetadataReader::readFromJson(
    const gsl::span<const std::byte>& data) const {
  ExtensionNodeExtStructuralMetadataJsonHandler handler(this->_options);
  return CesiumJsonReader::JsonReader::readJson(data, handler);
}
...
ExtensionNodeExtStructuralMetadataReader::readArrayFromJson(
    const rapidjson::Value& value) const {
  CesiumJsonReader::ArrayJsonHandler<
      CesiumGltf::ExtensionNodeExtStructuralMetadata,
      ExtensionNodeExtStructuralMetadataJsonHandler>
