...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionKhrMaterialsVariantsJsonHandler.h"
...
ExtensionKhrMaterialsVariantsJsonHandler::
    ExtensionKhrMaterialsVariantsJsonHandler(
        const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context),
      _variants(context) {}

void ExtensionKhrMaterialsVariantsJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::ExtensionKhrMaterialsVariants* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionKhrMaterialsVariantsJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionKhrMaterialsVariants(
      CesiumGltf::ExtensionKhrMaterialsVariants::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionKhrMaterialsVariantsJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, CesiumGltf::ExtensionKhrMaterialsVariants())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::ExtensionKhrMaterialsVariants&>(value));
}

CesiumJsonReader::IJsonHandler* ExtensionKhrMaterialsVariantsJsonHandler::
    readObjectKeyExtensionKhrMaterialsVariants(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::ExtensionKhrMaterialsVariants& o) {
  using namespace std::string_literals;
...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler.h"
...
ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler::
    ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler(
        const CesiumJsonReader::ExtensionReaderContext& context) noexcept
    : CesiumJsonReader::ExtensibleObjectJsonHandler(context),
      _mappings(context) {}

void ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionKhrMaterialsVariantsMeshPrimitive(
      CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler::reset(
  ...
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive&>(
          value));
}

CesiumJsonReader::IJsonHandler*
ExtensionKhrMaterialsVariantsMeshPrimitiveJsonHandler::
    readObjectKeyExtensionKhrMaterialsVariantsMeshPrimitive(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::ExtensionKhrMaterialsVariantsMeshPrimitive& o) {
  using namespace std::string_literals;
...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionKhrMaterialsVariantsMeshPrimitiveMappingsValueJsonHandler.h"
...
void ExtensionKhrMaterialsVariantsMeshPrimitiveMappingsValueJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
// This file was generated by generate-classes.
// DO NOT EDIT THIS FILE!
#include "ExtensionKhrMaterialsVariantsValueJsonHandler.h"
...
void ExtensionKhrMaterialsVariantsValueJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionKhrMaterialsVariantsValueJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionKhrMaterialsVariantsValue(
      CesiumGltf::ExtensionKhrMaterialsVariantsValue::TypeName,
      str,
      *this->_pObject);
}

CesiumJsonReader::IJsonHandler* ExtensionKhrMaterialsVariantsValueJsonHandler::
    readObjectKeyExtensionKhrMaterialsVariantsValue(
        const std::string& objectType,
        const std::string_view& str,
