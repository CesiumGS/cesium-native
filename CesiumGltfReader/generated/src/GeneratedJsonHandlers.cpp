...
#include <string>
    ...
    namespace CesiumGltfReader{
        ...
        ExtensionTextureBasisUJsonHandler::ExtensionTextureBasisUJsonHandler(const CesiumJsonReader::ExtensionReaderContext& context) noexcept : CesiumJsonReader::ExtensibleObjectJsonHandler(context), _source(){}

        void ExtensionTextureBasisUJsonHandler::reset(CesiumJsonReader::IJsonHandler* pParentHandler, CesiumGltf::ExtensionTextureBasisU* pObject){CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
this->_pObject = pObject;
}
