...
void KHR_texture_basisuGlTFExtensionJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::KHR_texture_basisuGlTFExtension* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
KHR_texture_basisuGlTFExtensionJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyKHR_texture_basisuGlTFExtension(
      CesiumGltf::KHR_texture_basisuGlTFExtension::TypeName,
      str,
      *this->_pObject);
}
...
void KHR_texture_basisuGlTFExtensionJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, CesiumGltf::KHR_texture_basisuGlTFExtension())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<CesiumGltf::KHR_texture_basisuGlTFExtension&>(value));
}

CesiumJsonReader::IJsonHandler* KHR_texture_basisuGlTFExtensionJsonHandler::
    readObjectKeyKHR_texture_basisuGlTFExtension(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::KHR_texture_basisuGlTFExtension& o) {
