...
class ExtensionExtMeshGpuInstancingExtFeatureMetadataJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionExtMeshGpuInstancingExtFeatureMetadata(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata& o);

private:
  CesiumGltf::ExtensionExtMeshGpuInstancingExtFeatureMetadata* _pObject =
      nullptr;
