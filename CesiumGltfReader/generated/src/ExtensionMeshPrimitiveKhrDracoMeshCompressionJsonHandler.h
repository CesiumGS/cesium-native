...
class ExtensionMeshPrimitiveKhrDracoMeshCompressionJsonHandler
...
protected:
  IJsonHandler* readObjectKeyExtensionMeshPrimitiveKhrDracoMeshCompression(
      const std::string& objectType,
      const std::string_view& str,
      CesiumGltf::ExtensionMeshPrimitiveKhrDracoMeshCompression& o);

private:
  CesiumGltf::ExtensionMeshPrimitiveKhrDracoMeshCompression* _pObject = nullptr;
