...
/**
 * @brief Reads {@link ExtensionExtFeatureMetadataEnumValue} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionExtFeatureMetadataEnumValueReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionExtFeatureMetadataEnumValue from a
   * byte buffer.
   *
  ...
  /**
   * @brief Reads an array of instances of ExtensionExtFeatureMetadataEnumValue
