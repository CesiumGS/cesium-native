...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue> readFromJson(const gsl::span<const std::byte>& data) const;
