...
/**
 * @brief Reads \ref CesiumGltf::ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue "ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue" instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValueReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue from a byte buffer.
   *
  ...
  /**
   * @brief Reads an instance of ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue from a rapidJson::Value.
   *
  ...
  /**
   * @brief Reads an array of instances of ExtensionMeshPrimitiveKhrMaterialsVariantsMappingsValue from a rapidJson::Value.
   *
