...
/**
 * @brief Reads {@link ExtensionExtStructuralMetadataPropertyAttributeProperty} instances from JSON.
 */
...
public:
   ...
   * ExtensionExtStructuralMetadataPropertyAttributeProperty from a byte buffer.
   *
  ...
  /**
   * @brief Reads an instance of
   * ExtensionExtStructuralMetadataPropertyAttributeProperty from a
   * rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
