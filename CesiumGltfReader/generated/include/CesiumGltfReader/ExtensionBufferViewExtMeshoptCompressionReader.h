...
/**
 * @brief Reads \ref CesiumGltf::ExtensionBufferViewExtMeshoptCompression "ExtensionBufferViewExtMeshoptCompression" instances from JSON.
 */
...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionBufferViewExtMeshoptCompression> readFromJson(const std::span<const std::byte>& data) const;
