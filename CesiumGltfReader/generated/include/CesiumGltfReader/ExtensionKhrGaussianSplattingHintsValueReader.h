...
/**
 * @brief Reads {@link ExtensionKhrGaussianSplattingHintsValue} instances from JSON.
 */
...
public:
  ...
  /**
   * @brief Reads an instance of ExtensionKhrGaussianSplattingHintsValue from a byte buffer.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionKhrGaussianSplattingHintsValue> readFromJson(const gsl::span<const std::byte>& data) const;

  /**
   * @brief Reads an instance of ExtensionKhrGaussianSplattingHintsValue from a rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  ...
  /**
   * @brief Reads an array of instances of ExtensionKhrGaussianSplattingHintsValue from a rapidJson::Value.
   *
