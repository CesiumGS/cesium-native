...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::CameraOrthographic> readFromJson(const gsl::span<const std::byte>& data) const;
  ...
  /**
   * @brief Reads an array of instances of CameraOrthographic from a rapidJson::Value.
   *
