...
/**
 * @brief Reads {@link ExtensionExtFeatureMetadataFeatureIDAttribute} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionExtFeatureMetadataFeatureIDAttributeReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionExtFeatureMetadataFeatureIDAttribute
   * from a byte buffer.
   *
   ...
   * ExtensionExtFeatureMetadataFeatureIDAttribute from a rapidJson::Value.
   *
