...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionTextureWebp> readFromJson(const gsl::span<const std::byte>& data) const;
  ...
  /**
   * @brief Reads an array of instances of ExtensionTextureWebp from a rapidJson::Value.
   *
