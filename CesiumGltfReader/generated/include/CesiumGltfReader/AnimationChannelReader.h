...
/**
 * @brief Reads \ref CesiumGltf::AnimationChannel "AnimationChannel" instances from JSON.
 */
...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::AnimationChannel> readFromJson(const std::span<const std::byte>& data) const;
