...
/**
 * @brief Reads {@link ExtensionExtFeatureMetadataFeatureTexture} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionExtFeatureMetadataFeatureTextureReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionExtFeatureMetadataFeatureTexture from
   * a byte buffer.
   *
   ...
   * ExtensionExtFeatureMetadataFeatureTexture from a rapidJson::Value.
   *
