...
/**
 * @brief Reads {@link ExtensionExtStructuralMetadataPropertyTextureProperty} instances from JSON.
 */
...
public:
   ...
   * ExtensionExtStructuralMetadataPropertyTextureProperty from a byte buffer.
   *
  ...
  /**
   * @brief Reads an instance of
   * ExtensionExtStructuralMetadataPropertyTextureProperty from a
   * rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
