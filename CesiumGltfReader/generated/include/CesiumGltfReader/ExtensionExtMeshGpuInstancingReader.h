...
public:
  ...
  /**
   * @brief Reads an instance of ExtensionExtMeshGpuInstancing from a byte buffer.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionExtMeshGpuInstancing> readFromJson(const gsl::span<const std::byte>& data) const;

  /**
   * @brief Reads an instance of ExtensionExtMeshGpuInstancing from a rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  ...
  /**
   * @brief Reads an array of instances of ExtensionExtMeshGpuInstancing from a rapidJson::Value.
   *
