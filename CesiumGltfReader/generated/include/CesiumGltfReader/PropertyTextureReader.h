...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::PropertyTexture> readFromJson(const gsl::span<const std::byte>& data) const;
  ...
  /**
   * @brief Reads an array of instances of PropertyTexture from a rapidJson::Value.
   *
