...
/**
 * @brief Reads \ref CesiumGltf::ExtensionKhrGaussianSplatting "ExtensionKhrGaussianSplatting" instances from JSON.
 */
...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionKhrGaussianSplatting> readFromJson(const std::span<const std::byte>& data) const;
