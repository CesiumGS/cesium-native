...
/**
 * @brief Reads {@link AccessorSparse} instances from JSON.
 */
...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::AccessorSparse> readFromJson(const gsl::span<const std::byte>& data) const;
  ...
  /**
   * @brief Reads an array of instances of AccessorSparse from a rapidJson::Value.
   *
