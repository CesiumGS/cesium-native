...
/**
 * @brief Reads {@link ExtensionExtFeatureMetadataFeatureIDs} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionExtFeatureMetadataFeatureIDsReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionExtFeatureMetadataFeatureIDs from a
   * byte buffer.
   *
  ...
  /**
   * @brief Reads an array of instances of ExtensionExtFeatureMetadataFeatureIDs
