...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::Mesh> readFromJson(const std::span<const std::byte>& data) const;
   ...
   * @return The result of reading the instance.
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::Mesh> readFromJson(const rapidjson::Value& value) const;
