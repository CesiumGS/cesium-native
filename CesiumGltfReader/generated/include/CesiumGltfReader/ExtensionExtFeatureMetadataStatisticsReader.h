...
/**
 * @brief Reads {@link ExtensionExtFeatureMetadataStatistics} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionExtFeatureMetadataStatisticsReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionExtFeatureMetadataStatistics from a
   * byte buffer.
   *
  ...
  /**
   * @brief Reads an array of instances of ExtensionExtFeatureMetadataStatistics
