...
/**
 * @brief Reads {@link ExtensionMeshPrimitiveExtFeatureMetadata} instances from JSON.
 */
class CESIUMGLTFREADER_API ExtensionMeshPrimitiveExtFeatureMetadataReader {
public:
  /**
  ...
  /**
   * @brief Reads an instance of ExtensionMeshPrimitiveExtFeatureMetadata from a
   * byte buffer.
   *
   ...
   * ExtensionMeshPrimitiveExtFeatureMetadata from a rapidJson::Value.
   *
