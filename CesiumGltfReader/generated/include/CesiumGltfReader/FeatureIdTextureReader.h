...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::FeatureIdTexture> readFromJson(const gsl::span<const std::byte>& data) const;
  ...
  /**
   * @brief Reads an array of instances of FeatureIdTexture from a rapidJson::Value.
   *
