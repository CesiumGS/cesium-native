...
/**
 * @brief Reads \ref CesiumGltf::AccessorSparseIndices "AccessorSparseIndices" instances from JSON.
 */
...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::AccessorSparseIndices> readFromJson(const std::span<const std::byte>& data) const;
