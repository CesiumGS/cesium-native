...
public:
   ...
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::PropertyTextureProperty> readFromJson(const gsl::span<const std::byte>& data) const;

  /**
   * @brief Reads an instance of PropertyTextureProperty from a rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  ...
  /**
   * @brief Reads an array of instances of PropertyTextureProperty from a rapidJson::Value.
   *
