...
public:
  ...
  /**
   * @brief Reads an instance of ExtensionExtInstanceFeaturesFeatureId from a byte buffer.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  CesiumJsonReader::ReadJsonResult<CesiumGltf::ExtensionExtInstanceFeaturesFeatureId> readFromJson(const gsl::span<const std::byte>& data) const;

  /**
   * @brief Reads an instance of ExtensionExtInstanceFeaturesFeatureId from a rapidJson::Value.
   *
   * @param data The buffer from which to read the instance.
   * @return The result of reading the instance.
   */
  ...
  /**
   * @brief Reads an array of instances of ExtensionExtInstanceFeaturesFeatureId from a rapidJson::Value.
   *
