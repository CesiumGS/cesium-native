...
void ExtensionModelExtFeatureMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    ExtensionModelExtFeatureMetadata* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}
...
ExtensionModelExtFeatureMetadataJsonHandler::readObjectKey(
  ...
  return this->readObjectKeyExtensionModelExtFeatureMetadata(
      ExtensionModelExtFeatureMetadata::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler* ExtensionModelExtFeatureMetadataJsonHandler::
    readObjectKeyExtensionModelExtFeatureMetadata(
        const std::string& objectType,
        const std::string_view& str,
        ExtensionModelExtFeatureMetadata& o) {
  using namespace std::string_literals;
...
void ExtensionPrimitiveExtFeatureMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionPrimitiveExtFeatureMetadataJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionPrimitiveExtFeatureMetadata(
      ExtensionPrimitiveExtFeatureMetadata::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionPrimitiveExtFeatureMetadataJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, ExtensionPrimitiveExtFeatureMetadata())
          .first->second;
  this->reset(
      pParentHandler,
      &std::any_cast<ExtensionPrimitiveExtFeatureMetadata&>(value));
}

CesiumJsonReader::IJsonHandler*
ExtensionPrimitiveExtFeatureMetadataJsonHandler::
    readObjectKeyExtensionPrimitiveExtFeatureMetadata(
        const std::string& objectType,
        const std::string_view& str,
