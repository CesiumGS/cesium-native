...
class ExtensionMeshPrimitiveMeshFeaturesJsonHandler
    : public CesiumJsonReader::ExtensibleObjectJsonHandler,
      public CesiumJsonReader::IExtensionJsonHandler {
public:
  using ValueType = ExtensionMeshPrimitiveMeshFeatures;
...
protected:
  IJsonHandler* readObjectKeyExtensionMeshPrimitiveMeshFeatures(
      const std::string& objectType,
      const std::string_view& str,
      ExtensionMeshPrimitiveMeshFeatures& o);

private:
  ExtensionMeshPrimitiveMeshFeatures* _pObject = nullptr;
