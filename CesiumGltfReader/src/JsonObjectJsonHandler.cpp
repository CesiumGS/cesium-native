...
namespace {
    template <typename T>
    void addOrReplace(JsonValue& json, T value) {
...
IJsonHandler* JsonObjectJsonHandler::RawNumber(const char* /* str */, size_t /* length */, bool /* copy */) {
    return nullptr;
}

IJsonHandler* JsonObjectJsonHandler::String(const char* str, size_t /* length */, bool /* copy */) {
...
IJsonHandler* JsonObjectJsonHandler::Key(const char* str, size_t /* length */, bool /* copy */) {
