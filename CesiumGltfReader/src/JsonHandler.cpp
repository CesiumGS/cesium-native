...
IJsonHandler* JsonHandler::RawNumber(const char* /*str*/, size_t /*length*/, bool /*copy*/) {
    this->reportWarning("A numeric value is not allowed and has been ignored.");
    return this->parent();
}

IJsonHandler* JsonHandler::String(const char* /*str*/, size_t /*length*/, bool /*copy*/) {
...
IJsonHandler* JsonHandler::Key(const char* /*str*/, size_t /*length*/, bool /*copy*/) {
    return nullptr;
}

IJsonHandler* JsonHandler::EndObject(size_t /*memberCount*/) {
    return nullptr;
}
...
IJsonHandler* JsonHandler::EndArray(size_t /*elementCount*/) {
    return nullptr;
}

IJsonHandler* JsonHandler::parent() {
...
void JsonHandler::reportWarning(const std::string& warning, std::vector<std::string>&& context) {
    this->parent()->reportWarning(warning, std::move(context));
}

void JsonHandler::reset(IJsonHandler* pParent) {
