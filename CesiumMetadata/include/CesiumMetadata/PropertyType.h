...
/**
 * @brief The possible types of a metadata property in glTF and 3D Tiles.
 */
...
/**
 * @brief The possible types of a numeric property component.
 */
...
/**
 * @brief Converts a string type listed in @ref CesiumGltf::AccessorSpec::Type
 * to its corresponding @ref PropertyType.
 *
 ...
 * CesiumGltf::AccessorSpec::Type.
 *
 * @param type The @ref PropertyType to convert to a string.
 * @returns The string listed in CesiumGltf::AccessorSpec::Type, or `"INVALID"`
 * if no conversion is possible.
 */
 ...
 * CesiumGltf::PropertyTableProperty::ArrayOffsetType to its corresponding @ref
 * PropertyComponentType.
 *
 * @param str The string to convert to a @ref PropertyComponentType.
 * @returns The string as a @ref PropertyComponentType, or @ref
...
/**
 * @brief Converts a string listed in @ref
 * CesiumGltf::PropertyTableProperty::StringOffsetType to its corresponding @ref
 * PropertyComponentType.
 *
 * @param str The string to convert to a @ref PropertyComponentType.
 * @returns The string as a @ref PropertyComponentType, or @ref
 ...
 * CesiumGltf::AccessorSpec::ComponentType to its corresponding @ref
 * PropertyComponentType.
 *
 ...
 * @ref CesiumGltf::AccessorSpec::ComponentType.
 *
 * @param componentType The @ref PropertyComponentType to convert to an integer
 * type ID.
 * @returns The integer type ID listed in @ref
 * CesiumGltf::AccessorSpec::ComponentType, or -1 if no conversion is possible.
 */
