...
namespace CesiumAsync {
	...
	public:
		/**
		 * @brief Constructor.
		 * @param mustRevalidate Must-Revalidate directive that appears in the Cache-Control header
		 ...
		 * @param noTransform No-Transform directive that appears in the Cache-Control header
		 * @param accessControlPublic Public directive that appears in the Cache-Control header
		 * @param accessControlPrivate Private directive that appears in the Cache-Control header
		 * @param proxyRevalidate Proxy-Revalidate directive that appears in the Cache-Control header
		 * @param maxAge Max-Age directive that appears in the Cache-Control header
		 * @param sharedMaxAge S-Maxage directive that appears in the Cache-Control header
		 */
