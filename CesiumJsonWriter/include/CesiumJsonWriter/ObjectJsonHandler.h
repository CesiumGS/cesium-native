...
class CESIUMJSONWRITER_API ObjectJsonHandler : public JsonHandler {
public:
  ObjectJsonHandler() noexcept : JsonHandler() {}

  virtual IJsonHandler* writeObjectStart() override /* final */;
  virtual IJsonHandler* writeObjectEnd() override /* final */;
