...
void writeJson(
  ...
  if (obj.componentType != Cesium3DTiles::ClassProperty::ComponentType::INT8) {
...
void writeJson(
  ...
  if (obj.constant != Cesium3DTiles::Availability::Constant::UNAVAILABLE) {
...
void writeJson(
  ...
  if (obj.refine != Cesium3DTiles::Tile::Refine::ADD) {
