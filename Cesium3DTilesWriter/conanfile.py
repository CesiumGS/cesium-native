...
class CesiumUtilityConan(ConanFile):
    ...
    description = "3D Tiles serialization, including 3D Tiles extension support."
    topics = () # TODO
    ...
    def package_info(self):
      ...
      self.cpp_info.set_property("cmake_file_name", "Cesium3DTilesWriter")
      self.cpp_info.set_property("cmake_target_name", "Cesium3DTilesWriter::Cesium3DTilesWriter")