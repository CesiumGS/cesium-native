 ...
 */
struct CESIUM3DTILESPIPELINE_API TilesetContentOptions {
  /**
 ...
 */
struct CESIUM3DTILESPIPELINE_API FogDensityAtHeight {
 ...
 */
struct CESIUM3DTILESPIPELINE_API TilesetOptions {
  /**
