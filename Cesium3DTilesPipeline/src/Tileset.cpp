#include "Cesium3DTilesPipeline/Tileset.h"
#include "Cesium3DTilesPipeline/CreditSystem.h"
#include "Cesium3DTilesPipeline/ExternalTilesetContent.h"
#include "Cesium3DTilesPipeline/RasterMappedTo3DTile.h"
 ...
 * always be rendered (see {@link Cesium3DTilesPipeline::TilesetOptions})
...
static bool isVisibleFromCamera(
  ...
  const CesiumGeospatial::GlobeRectangle* pRectangle =
      Cesium3DTilesPipeline::Impl::obtainGlobeRectangle(&boundingVolume);
...
bool Tileset::_kickDescendantsAndRenderTile(
  ...
  if (tile.getRefine() != Cesium3DTilesPipeline::TileRefine::Add) {
