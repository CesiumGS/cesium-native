...
namespace Cesium3DTiles {
    namespace Impl {
        ...
        /**
         * @brief Obtains the {@link CesiumGeospatial::GlobeRectangle} from the given {@link Cesium3DTiles::BoundingVolume}.
         *
         * If the given bounding volume is a {@link CesiumGeospatial::BoundingRegion},
         * then its rectangle will be returned.
         *
         * If the given bounding volume is a {@link CesiumGeospatial::BoundingRegionWithLooseFittingHeights},
         * then the rectangle of its bounding region  will be returned.
         *
