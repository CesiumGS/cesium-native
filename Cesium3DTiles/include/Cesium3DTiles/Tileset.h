...
namespace Cesium3DTiles {
    ...
    private:
        ...
        TraversalDetails _visitTile(uint32_t lastFrameNumber, uint32_t currentFrameNumber, uint32_t depth, const Camera& camera, bool ancestorMeetsSse, Tile& tile, ViewUpdateResult& result);
