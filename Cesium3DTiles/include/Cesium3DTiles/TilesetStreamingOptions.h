 ...
 *
 * @see TilesetStreamingOptions::fogDensityTable
 */
...
/**
 * @brief Options for configuring the streaming behavior of a {@link Tileset}.
 */
struct CESIUM3DTILES_API TilesetStreamingOptions {
