 ...
 */
struct CESIUM3DTILES_API SubtreeMetadata final
    : public CesiumUtility::ExtensibleObject {
  static inline constexpr const char* TypeName = "SubtreeMetadata";
   ...
   * JSON number. For `ENUM` use a valid enum `name`, not an integer value. For
   * `ARRAY`, `VECN`, and `MATN` types use a JSON array containing values
   * matching the `componentType`. Required properties must be included in this
   * dictionary.
   */
