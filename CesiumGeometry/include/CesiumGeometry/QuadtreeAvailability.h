...
public:
   ...
   * tile.
   *
   * @param tileID The @ref CesiumGeometry::QuadtreeTileID for the tile.
   *
   * @return The @ref TileAvailabilityFlags for this tile encoded into a
   * uint8_t.
   */
   ...
   *
   * @param tileID The @ref CesiumGeometry::QuadtreeTileID for the tile.
   * @param newSubtree The @ref CesiumGeometry::AvailabilitySubtree to add.
   *
