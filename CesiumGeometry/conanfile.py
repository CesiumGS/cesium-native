...
class CesiumUtilityConan(ConanFile):
    ...
    description = "Common 3D geometry classes; and bounds testing, intersection testing, and spatial indexing algorithms."
    topics = () # TODO
    ...
    def package_info(self):
      ...
      self.cpp_info.set_property("cmake_file_name", "CesiumGeometry")
      self.cpp_info.set_property("cmake_target_name", "CesiumGeometry::CesiumGeometry")