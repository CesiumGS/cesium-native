...
enum GeocoderRequestType {
   ...
   * is typing.
   * The search results may be less accurate or exhaustive than using @ref GeocoderRequestType::Search.
   */
  Autocomplete
};
...
struct GeocoderFeature {
  ...
  /**
   * @brief Returns a @ref CesiumGeospatial::GlobeRectangle representing this feature.
   *
  ...
  /**
   * @brief Returns a @ref CesiumGeospatial::Cartographic representing this feature.
   *
   * If the geocoder service returned a bounding box for this result, this will
