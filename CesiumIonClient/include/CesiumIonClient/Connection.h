...
namespace CesiumIonClient {
    ...
    public:
         ...
         * @param friendlyApplicationName A friendly name for the application requesting access. It will be displayed to the user when
         *        authorization is complete, informing them that they can return to the original application.
         * @param clientID The client ID that was assigned to your application when you registered it.
         * @param redirectPath The path on http://127.0.0.1 that a user will be redirected to once they authorize your application.
         *        This must match the URI provided when you registered your application, without the protocol, hostname, or port.
         * @param scopes The list of scopes that the eventually-granted token should allow access to.
         * @param openUrlCallback A function that is invoked to launch the user's web browser with a given URL so that they can authorize access.
         ...
         * @return A future that resolves to a Cesium ion {@link Connection} once the user authorizes
         *         the application and the token handshake completes.
         */
