...
namespace CesiumIonClient {
    ...
    struct Asset {
        ...
        /**
         * @brief A Markdown compatible string containing any required attribution for this asset.
         * 
        ...
        /**
         * @brief The date and time that this asset was created in [RFC 3339](https://tools.ietf.org/html/rfc3339) format.
         */
        std::string dateAdded;

        /**
         * @brief Describes the state of the asset during the upload and tiling processes.
         * 
         * | *Value* | *Description* |
    ...
    struct Assets {
        /**
         * @brief An [RFC 5988](https://tools.ietf.org/html/rfc5988) formatted string with a relation type of next which points to the next page of data on the server, if it exists.
         * 
