...
class CESIUMGLTFWRITER_API ImageManipulation {
public:
  /**
   ...
   * image.
   * @param pSource The pointer at which to start writing pixels.
   ...
   * @param source The image from which to write pixels.
   * @param sourcePixels The pixels to write from the target.
