 ...
 *
 * @returns A {@link CesiumGltfWriter::WriteModelResult} containing a list of
 ...
 * is non empty, a AmbiguousDataSource error will be returned.
 ...
 * {@link CesiumGltfWriter::writeModelAndExternalFiles} for external file
 * support).
 */

CESIUMGLTFWRITER_API WriteModelResult writeModelAsEmbeddedBytes(
 ...
 * @details Simialr to {@link CesiumGltfWriter::writeModelAsEmbeddedBytes}, with the
